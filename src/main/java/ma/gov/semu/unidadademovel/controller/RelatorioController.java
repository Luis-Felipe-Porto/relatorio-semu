package ma.gov.semu.unidadademovel.controller;
...
public class RelatorioController {
	...
	public void imprimir(@RequestParam Map<String, Object> parametros, HttpServletResponse response) throws JRException, SQLException, IOException {
		...
		InputStream jasperStream = this.getClass().getResourceAsStream("/relatorios/relatorio_semu.jasper");
		...
		response.setHeader("Content-Disposition", "inline; filename=relatorio_semu.pdf");
